# Ebanux APIv2 Specifications
[View-On-Line](https://ebanux.github.io/ebanux-api-v2-specs)

## Introduction

This repo has official reference of the Ebanux APIv2 specifications. The spec is OpenAPI 3.1.0 (aka swagger).

## Links

- [Reference Documentation (ReDoc)](https://ebanux.github.io/ebanux-api-v2-specs)
- OpenAPI Raw Files: [JSON](https://ebanux.github.io/ebanux-api-v2-specs/openapi.json) [YAML](https://ebanux.github.io/ebanux-api-v2-specs/openapi.yaml)
- [![Run in Postman](https://run.pstmn.io/button.svg)](https://app.getpostman.com/run-collection/123456789)
